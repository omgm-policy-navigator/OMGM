...
소유 데이터: 정책 식별자, 정책명, 기관, 지역, 대상, 신청 기간, 원문, 출처, 수집 시점, 정책 버전, 원문 해시, 정책 상태.
...
소유 데이터: 조건 식별자, 조건 유형, 비교 연산자, 기준값, 단위, 필수 여부, 원문 근거 위치, 구조화 검증 상태, 적용 정책 버전.
...
소유 데이터: 판정 식별자, 사용자 또는 세션 식별자, 정책 식별자, 판정 상태, 판정 시점, 정책 버전, 사용자 정보 버전, 충족 조건, 불충족 조건, 미확인 조건, 판정 근거.
