...
Result: passed. 51 tests passed in the Linux backend container.
...
- JSON output mode is validated with mocked Ollama responses because the local `qwen3:4b` model is not installed in this environment.
