...
- Expanded `app/modules/eligibility` into a pure deterministic Rule Engine with B5 operators.
- Added required and optional condition handling, limited OR groups, application-window status handling, official-confirmation buckets, and recommendation scoring.
...
- Added unit tests for supported operators, missing facts, failed required rules, ended/future application periods, invalid operators, OR groups, official confirmation, and deterministic repeated results.
